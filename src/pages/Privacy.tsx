...
const Privacy = () => {
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Privacy Policy for Founders | Foundterra</title>
        <meta name="description" content="Learn how Foundterra protects founder data across our investor-ready pitch deck and fundraising advisory services." />
        <link rel="canonical" href="https://www.foundterra.com/privacy" />
      </Helmet>
      <Header />
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="bg-card rounded-lg p-8 border">
                  <div className="text-foreground space-y-6 leading-relaxed">
                    <p>
                      This Privacy Notice for Foundterra ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
                    </p>
                    <ul className="list-disc pl-6 space-y-1">
                      <li>Visit our website at http://www.foundterra.com or any website of ours that links to this Privacy Notice</li>
                      <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                    </ul>
                    
                    <p>
                      Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at info@foundterra.com.
                    </p>

                    <div className="mt-8">
                      <h2 className="text-xl font-semibold mb-4">SUMMARY OF KEY POINTS</h2>
                      <p className="mb-4">
                    ...
                    <div className="mt-8 space-y-8">
                      <div>
                        <h2 className="text-xl font-semibold mb-4">1. WHAT INFORMATION DO WE COLLECT?</h2>
                        
                        <h3 className="text-lg font-medium mb-3">Personal information you disclose to us</h3>
                        <p className="font-medium mb-2">In Short: We collect personal information that you provide to us.</p>
                        ...
                        <h3 className="text-lg font-medium mb-3">Information automatically collected</h3>
                        <p className="font-medium mb-2">In Short: Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Services.</p>
                      ...
                      <div>
                        <h2 className="text-xl font-semibold mb-4">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
                        <p className="font-medium mb-2">In Short: We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law.</p>
                      ...
                      <div>
                        <h2 className="text-xl font-semibold mb-4">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
                        <p className="font-medium mb-4">In Short: We only process your personal information when we believe it is necessary and we have a valid legal reason to do so under applicable law.</p>
                        
                        <p className="mb-4">If you are located in the EU or UK, this section applies to you. The General Data Protection Regulation (GDPR) and UK GDPR require us to explain the valid legal bases we rely on to process your personal information.</p>
                      </div>

                      <div>
                        <h2 className="text-xl font-semibold mb-4">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                        <p className="font-medium mb-4">In Short: We may share information in specific situations described in this section.</p>
                      ...
                      <div>
                        <h2 className="text-xl font-semibold mb-4">5. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                        <p className="font-medium mb-4">In Short: We keep your information for as long as necessary to fulfill the purposes outlined in this Privacy Notice unless otherwise required by law.</p>
                      </div>

                      <div>
                        <h2 className="text-xl font-semibold mb-4">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
                        <p className="font-medium mb-4">In Short: We aim to protect your personal information through a system of organizational and technical security measures.</p>
                      </div>

                      <div>
                        <h2 className="text-xl font-semibold mb-4">7. DO WE COLLECT INFORMATION FROM MINORS?</h2>
                        <p className="font-medium mb-4">In Short: We do not knowingly collect data from or market to children under 18 years of age.</p>
                      </div>

                      <div>
                        <h2 className="text-xl font-semibold mb-4">8. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                        <p className="font-medium mb-4">In Short: Depending on your state of residence, you have rights that allow you greater access to and control over your personal information.</p>
                      </div>

                      <div>
                        <h2 className="text-xl font-semibold mb-4">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                        <p className="mb-4">If you have questions or comments about this notice, you may contact us at:</p>
                        <p><strong>Foundterra</strong><br />Email: info@foundterra.com</p>
                      </div>
                    </div>
                  </div>
                </div>
